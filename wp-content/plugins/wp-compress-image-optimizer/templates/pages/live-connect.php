<div class="wps-ic-connect-form" style="display: none;">
  ...
  <div id="wps-ic-connection-tests-done" style="display: none;">
    ...
    echo '<div class="ic-input-holder">';
    echo '<a href="' . admin_url('options-general.php?page=wpcompress') . '" class="button button-primary">Start</a>';
    echo '<a href="' . admin_url('options-general.php?page=wpcompress') . '" class="grey-link" style="display:block;">I want to use Legacy Mode</a>';
    echo '</div>';
    echo '</div>';
    ?>
  </div>
  ...
  <div class="wps-ic-connect-inner">
    <form method="post" action="<?php echo admin_url('options-general.php?page=wpcompress&do=activate'); ?>" id="wps-ic-connect-form">
      ...
      <div class="wps-ic-success-message-container-text" style="display: none;">
        <div class="wps-ic-success-message-container-text" style="display: block">
          ...
          <a href="<?php echo admin_url('options-general.php?page=wpcompress'); ?>" class="wps-ic-dashboard-btn">Continue</a>
        </div>
      </div>

      <div class="wps-ic-tests-container" style="display: none;">
        <ul>
          <li><img src="<?php echo WPS_IC_URI; ?>assets/images/live/tail-spin.svg"/> Connecting to WP Compress Cloud</li>
        </ul>
      </div>
