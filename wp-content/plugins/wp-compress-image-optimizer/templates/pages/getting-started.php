    ...
    <div class="wp-compress-header" style="background: #383838;">
      ...
      <div class="wps_ic_form_centered">
        ...
        <div id="wps-ic-connection-tests-done" style="display: none;">
					...
					echo '</ul>';
					echo '<div class="ic-input-holder">';
					echo '<a href="' . admin_url('admin.php?page=wpcompress&set_recommended=true') . '" class="button button-primary">Use Recommended Settings</a>';
					echo '<a href="' . admin_url('admin.php?page=wpcompress') . '" class="grey-link">No Thanks, I\'ll Configure Settings</a>';
					echo '</div>';
					echo '</div>';
					?>
        </div>
