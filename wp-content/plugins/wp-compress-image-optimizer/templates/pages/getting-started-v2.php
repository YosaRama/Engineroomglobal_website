    ...
    <div class="wp-compress-header" style="background: #383838;">
      ...
      <div class="wps_ic_form_centered">
        ...
        <div id="wps-ic-connection-tests-done" style="display: none;">
          ...
          echo '<div class="ic-input-holder">';
          echo '<a href="' . admin_url('admin.php?page=wpcompress&enable_live=true&set_recommended=true') . '" class="button button-primary">Start</a>';
          echo '<a href="' . admin_url('admin.php?page=wpcompress&enable_live=false') . '" class="grey-link" style="display:block;">I want to use Legacy Mode</a>';
          echo '</div>';
          echo '</div>';
          ?>
        </div>

        <form method="post" action="<?php echo admin_url('admin.php?page=wpcompress&do=activate'); ?>" id="wps_ic_activate_form">
